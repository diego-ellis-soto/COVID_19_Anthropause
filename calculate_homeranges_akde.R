...
#occurrence
# message("saving OCCURRENCE UDs/shapefiles")
# 
# UD.occ<-raster(occ.est, DF="PMF")
# # UD.occ<-projectRaster(UD.occ, crs="+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_defs")
# 
# iso.occ.99<-SpatialPolygonsDataFrame.UD(occ.est,level.UD=0.999)
# # iso.occ.99<-spTransform(iso.occ.99, CRS("+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_defs"))
# 
# iso.occ.95<-SpatialPolygonsDataFrame.UD(occ.est,level.UD=0.95)
# # iso.occ.95<-spTransform(iso.occ.95, CRS("+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_defs"))
# 
# iso.occ.50<-SpatialPolygonsDataFrame.UD(occ.est,level.UD=0.50)
# # iso.occ.50<-spTransform(iso.occ.50, CRS("+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_defs"))
# 
# writeRaster(UD.occ, overwrite=TRUE,
#             filename=paste("/Users/diegoellis/projects/COVID/Output/Individual_lvl_summaries/HR_results_new/",
#                            paste(paste(unique(tmp$individual.local.identifier), 
#                                        phases[d], sep="_"),".RData", sep=""), sep=""))
# 
# writeOGR(iso.occ.99, check_exists=TRUE, overwrite_layer=TRUE,
#          dsn="/Users/diegoellis/projects/COVID/Output/Individual_lvl_summaries/HR_results_new/", 
#          layer=paste(unique(tmp$individual.local.identifier), phases[d], "99", sep="_"), driver="ESRI Shapefile")
# 
# writeOGR(iso.occ.95, check_exists=TRUE, overwrite_layer=TRUE,
#          dsn="/Users/diegoellis/projects/COVID/Output/Individual_lvl_summaries/HR_results_new/", 
#          layer=paste(unique(tmp$individual.local.identifier), phases[d], "95", sep="_"),
#          driver="ESRI Shapefile")
# 
# writeOGR(iso.occ.50, check_exists=TRUE, overwrite_layer=TRUE,
#          dsn="/Users/diegoellis/projects/COVID/Output/Individual_lvl_summaries/HR_results_new/", 
#          layer=paste(unique(tmp$individual.local.identifier), phases[d], "50", sep="_"),
#          driver="ESRI Shapefile")
# 
...
# print("FINISHED HR & OCCURENCE for seasonal ranges")
